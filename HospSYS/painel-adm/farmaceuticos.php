      ...
      <div class="modal-body">
        ...
        <form id="form" method=POST enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label for="exampleFormControlInput1">Carteira Profissional</label>
                <input type="text" class="form-control" id="cedula" placeholder="Carteira Profissional" name="cedula" value="<?php echo @$cedula ?>" required>
              </div>
            </div>
          </div>
