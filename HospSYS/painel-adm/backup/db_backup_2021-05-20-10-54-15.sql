...
CREATE TABLE `chamadas` (
  ...
  ADD CONSTRAINT `chamadas_ibfk_1` FOREIGN KEY (`paciente`) REFERENCES `pacientes` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4;

INSERT INTO chamadas VALUES("1","2","123","a Consultar");
...
CREATE TABLE `consultas` (
  ...
  ADD CONSTRAINT `consultas_ibfk_1` FOREIGN KEY (`medico`) REFERENCES `utilizadores` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `consultas_ibfk_2` FOREIGN KEY (`paciente`) REFERENCES `pacientes` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `consultas_ibfk_3` FOREIGN KEY (`tipo_atendimento`) REFERENCES `atendimentos` (`id`) ON DELETE CASCADE
...
INSERT INTO consultas VALUES("102","2021-05-20","11:30:00","2","1","4","1500.00","Não","a Aguardar",NULL,NULL,NULL);
INSERT INTO consultas VALUES("103","2021-05-20","07:00:00","2","1","4","1500.00","Não","a Aguardar",NULL,NULL,NULL);
INSERT INTO consultas VALUES("104","2021-05-20","06:00:00","2","1","4","1500.00","Não","Finalizada",NULL,NULL,NULL);
INSERT INTO consultas VALUES("105","2021-05-20","16:30:00","2","1","4","1500.00","Não","a Aguardar",NULL,NULL,NULL);
INSERT INTO consultas VALUES("106","2021-05-20","15:30:00","2","1","4","1500.00","Não","a Aguardar",NULL,NULL,NULL);
...
INSERT INTO contas_pagar VALUES("2","Conta Água","250.00","2021-05-20",NULL,"Não",NULL,"sem-foto.png");
...
INSERT INTO contas_receber VALUES("5","1","1500.00","2021-05-20",NULL,NULL,NULL,NULL,"104");
