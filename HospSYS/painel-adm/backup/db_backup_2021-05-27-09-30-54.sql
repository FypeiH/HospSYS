...
CREATE TABLE `chamadas` (
  ...
  CONSTRAINT `chamadas_ibfk_1` FOREIGN KEY (`paciente`) REFERENCES `pacientes` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4;

INSERT INTO chamadas VALUES("1","1","123","a Aguardar");
...
CREATE TABLE `consultas` (
  ...
  `prescricao` varchar(15) DEFAULT NULL,
...
INSERT INTO consultas VALUES("69","2021-04-10","06:00:00","1","1","4","1500.00","Não","Finalizada",NULL,"Sim","Sim");
INSERT INTO consultas VALUES("99","2021-05-16","05:30:00","1","1","4","1500.00","Sim","Finalizada",NULL,NULL,NULL);
INSERT INTO consultas VALUES("104","2021-05-20","06:00:00","2","1","4","1500.00","Sim","Finalizada",NULL,"Sim","Sim");
INSERT INTO consultas VALUES("105","2021-05-20","16:30:00","2","1","4","1500.00","Sim","Finalizada",NULL,NULL,NULL);
INSERT INTO consultas VALUES("106","2021-05-20","15:30:00","2","1","4","1500.00","Sim","Finalizada",NULL,NULL,NULL);
INSERT INTO consultas VALUES("115","2021-05-27","11:30:00","1","1","4","1500.00","Não","a Aguardar",NULL,NULL,NULL);
INSERT INTO consultas VALUES("116","2021-05-27","08:30:00","1","1","4","1500.00","Não","a Aguardar",NULL,NULL,NULL);
INSERT INTO consultas VALUES("117","2021-05-27","15:00:00","1","1","4","1500.00","Não","a Aguardar",NULL,NULL,NULL);
INSERT INTO consultas VALUES("118","2021-05-27","19:15:00","1","1","4","1500.00","Não","a Aguardar",NULL,NULL,NULL);
INSERT INTO consultas VALUES("119","2021-05-27","07:30:00","1","1","4","1500.00","Não","a Aguardar",NULL,NULL,NULL);
...
INSERT INTO contas_pagar VALUES("2","Conta Água","250.00","2021-05-20","2021-05-20","Sim","1","sem-foto.png");
INSERT INTO contas_pagar VALUES("3","Compra do/a Ben\'uron","100.00","2021-05-20","2021-05-20","Sim","1","sem-foto.png");
INSERT INTO contas_pagar VALUES("4","Compra do/a Brufen","10.00","2021-05-20","2021-05-20","Sim","1","sem-foto.png");
INSERT INTO contas_pagar VALUES("5","Luz","200.00","2021-05-20","2021-05-20","Sim","1","sem-foto.png");
INSERT INTO contas_pagar VALUES("7","Teste","253.12","2021-05-20","2021-05-20","Sim","1","sem-foto.png");
INSERT INTO contas_pagar VALUES("9","Teste1","200.99","2021-05-20","2021-05-20","Sim","1","sem-foto.png");
INSERT INTO contas_pagar VALUES("10","Compra do/a Pílula","5.98","2021-05-20","2021-05-20","Sim","1","sem-foto.png");
...
INSERT INTO contas_receber VALUES("4","1","1500.00","2021-05-16","2021-05-16","Dinheiro","à vista","3","99");
INSERT INTO contas_receber VALUES("5","1","1500.00","2021-05-20","2021-05-20","Cartão","VISA","1","104");
INSERT INTO contas_receber VALUES("6","1","1500.00","2021-05-20","2021-05-20","Plano de Saúde","Unimed","1","106");
INSERT INTO contas_receber VALUES("7","1","1500.00","2021-05-20","2021-05-20","Dinheiro","à vista","1","105");
...
INSERT INTO entradas_remedios VALUES("2","3","5","20.00","1","1","2021-05-20");
INSERT INTO entradas_remedios VALUES("3","4","2","5.00","1","1","2021-05-20");
INSERT INTO entradas_remedios VALUES("4","2","2","2.99","1","1","2021-05-20");
...
INSERT INTO fornecedores VALUES("2","FornecedorBru\'fen","342.345.342","fornecedorBrufen@gmail.com","(+516) 466212146","4");
...
INSERT INTO messages VALUES("20","1","4","oioi");
INSERT INTO messages VALUES("21","4","1","oioi");
INSERT INTO messages VALUES("22","3","1","OIOIOIOIOI");
INSERT INTO messages VALUES("23","1","3","eaeeeeeeeeeeeee");
INSERT INTO messages VALUES("24","1","4","ypypypypp");
INSERT INTO messages VALUES("25","3","1","aeeeeee");
INSERT INTO messages VALUES("26","6","1","jo");
...
INSERT INTO movimentacoes VALUES("3","Entrada","Cirurgia Plástica","1500.00","3","2021-05-16","4",NULL,NULL);
INSERT INTO movimentacoes VALUES("4","Entrada","Cirurgia Plástica","1500.00","1","2021-05-20","7",NULL,NULL);
INSERT INTO movimentacoes VALUES("5","Entrada","Cirurgia Plástica","1500.00","1","2021-05-20","5",NULL,NULL);
INSERT INTO movimentacoes VALUES("6","Saída","Conta Água","250.00","1","2021-05-20",NULL,"2",NULL);
INSERT INTO movimentacoes VALUES("7","Saída","Salário dos Funcionários","1000.00","1","2021-05-20",NULL,NULL,"2");
INSERT INTO movimentacoes VALUES("8","Saída","Luz","200.00","1","2021-05-20",NULL,"5",NULL);
INSERT INTO movimentacoes VALUES("9","Saída","Compra do/a Brufen","10.00","1","2021-05-20",NULL,"4",NULL);
INSERT INTO movimentacoes VALUES("10","Saída","Compra do/a Ben\'uron","100.00","1","2021-05-20",NULL,"3",NULL);
INSERT INTO movimentacoes VALUES("11","Saída","Teste","253.12","1","2021-05-20",NULL,"7",NULL);
INSERT INTO movimentacoes VALUES("12","Saída","Teste1","200.99","1","2021-05-20",NULL,"9",NULL);
INSERT INTO movimentacoes VALUES("13","Saída","Compra do/a Pílula","5.98","1","2021-05-20",NULL,"10",NULL);
INSERT INTO movimentacoes VALUES("14","Saída","Salário dos Funcionários","450.21","1","2021-05-20",NULL,NULL,"3");
INSERT INTO movimentacoes VALUES("15","Entrada","Cirurgia Plástica","1500.00","1","2021-05-20","6",NULL,NULL);
...
INSERT INTO pacientes VALUES("1","Paciente","222.222.222","2222","(+546) 43563456","pacienteuti@gmail.com","2002-02-22","18","Solteiro","Masculino","fsdafsdf","202cb962ac59075b964b07152d234b70","11/03/2021 - Dores de Cabeça");
...
INSERT INTO pagamentos VALUES("2","1","1000.00","1","2021-05-20");
INSERT INTO pagamentos VALUES("3","6","450.21","1","2021-05-20");
...
CREATE TABLE `prescricao` (
  ...
  `remedio` varchar(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_consulta` (`id_consulta`),
  CONSTRAINT `prescricao_ibfk_1` FOREIGN KEY (`id_consulta`) REFERENCES `consultas` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb4;

INSERT INTO prescricao VALUES("25","69","1","Pilula");
INSERT INTO prescricao VALUES("26","69","2","Comprimidos");
INSERT INTO prescricao VALUES("34","69","3","teste");
INSERT INTO prescricao VALUES("35","104","1","Ben\'uron");
INSERT INTO prescricao VALUES("36","104","2","Pilula");
...
INSERT INTO receitas VALUES("1","69","1","pilula");
INSERT INTO receitas VALUES("13","104","1","Ben\'uron");
INSERT INTO receitas VALUES("14","104","2","Aspirina");
...
INSERT INTO remedios VALUES("1","Aspirina","25mg","3");
INSERT INTO remedios VALUES("2","Pílula","15mg","2");
INSERT INTO remedios VALUES("3","Ben\'uron","100mg","5");
INSERT INTO remedios VALUES("4","Brufen","150mg","2");
...
INSERT INTO saidas_remedios VALUES("1","1","2","6","2021-05-20");
...
INSERT INTO utilizadores VALUES("1","HospSYSAdmin","hospsys@gmail.com","000.000.000","00000","(+000) 000000000","2002-09-25","2002-02-22",NULL,NULL,NULL,"25d55ad283aa400af464c76d713c07ad","Admin","7112260bf4b8bfec008141c99e0f296a7951355br1-736-736v2_hq.jpg","569991","Online","Ativo");
...
INSERT INTO utilizadores VALUES("4","António","medico@gmail.com","111.111.111","11111","(+111) 111111111","2002-02-22","2002-02-22","000","2","123","bbb8aae57c104cda40c93843ad5e6db8","Médico","sem-foto.png",NULL,"Offline","Ativo");
