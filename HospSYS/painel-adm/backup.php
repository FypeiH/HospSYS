...
foreach($tabelas as $tabela){
    ...
    for($i = 0; $i < $num_colunas; $i++){
        //Ler o valor de cada coluna na base de dados
...
if(file_exists($download)){
    ...
    $_SESSION['msg'] = "<span style='color: green;'>BD exportada com sucesso</span>";
}else{
    $_SESSION['msg'] = "<span style='color: red;'>Erro ao exportar a BD</span>";
}
