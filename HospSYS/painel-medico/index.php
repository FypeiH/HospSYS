...
if(!isset($_SESSION['nome_utilizador']) || $_SESSION['nivel_utilizador'] == 'Tesoureiro' || $_SESSION['nivel_utilizador'] == 'Farmacêutico' || $_SESSION['nivel_utilizador'] == 'Recepcionista' || $_SESSION['nivel_utilizador'] == 'Tela')
{
		...
		<div class="col-md-12">
			...
			<li class="float-right nav-item dropdown">		
				...
				<a class="float-right nav-link dropdown-toggle mt-1" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					Médico - <?php echo $nome_utilizador; ?>
				</a>
				...
				<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
					...
					<?php
						...
						{
							echo '<li><a class="dropdown-item" href="../painel-escolha/medico.php">Mudar Painel</a></li>';
						}
		...
		<div class="row">
			<div class="col-md-3 col-sm-12 mb-4">
				<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					...
					<a class="nav-link <?php echo $item2ativo ?>" id="link-medicos" href="index.php?acao=<?php echo $item2 ?>" role="tab" aria-controls="v-pills-profile" aria-selected="false"><i class="fas fa-calendar-check mr-1"></i>Consultas</a>

					<a class="nav-link <?php echo $item3ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item3 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-clinic-medical mr-1"></i>Consultório</a>

					<a class="nav-link <?php echo $item4ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item4 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-receipt mr-1"></i>Receitas</a>

					<a class="nav-link <?php echo $item5ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item5 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-file-prescription mr-1"></i>Prescrições</a>

					<a class="nav-link <?php echo $item6ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item6 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-file-alt mr-1"></i>Atestados</a>
					
					<a class="nav-link <?php echo $item8ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item8 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-comments mr-1"></i>Chat</a>
				</div>
			</div>
