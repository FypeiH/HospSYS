...
if(!isset($_SESSION['nome_utilizador']) || $_SESSION['nivel_utilizador'] == 'Tesoureiro' || $_SESSION['nivel_utilizador'] == 'Recepcionista' || $_SESSION['nivel_utilizador'] == 'Médico' || $_SESSION['nivel_utilizador'] == 'Tela')
{
			...
			<div class="col-md-12">
				...
				<li class="float-right nav-item dropdown">		
					...
					<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
						...
						{
							echo '<li><a class="dropdown-item" href="../painel-escolha/farmaceutico.php">Mudar Painel</a></li>';
						}
		...
		<div class="row">
			<div class="col-md-3 col-sm-12 mb-4">
				<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					...
					<a class="nav-link <?php echo $item2ativo ?>" id="link-medicos" href="index.php?acao=<?php echo $item2 ?>" role="tab" aria-controls="v-pills-profile" aria-selected="false"><i class="fas fa-capsules mr-1"></i>Registo de Remédios</a>

					<a class="nav-link <?php echo $item3ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item3 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-pills mr-1"></i>Entrada de Remédios</a>

					<a class="nav-link <?php echo $item4ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item4 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-tablets mr-1"></i>Saída de Remédios</a>

					<a class="nav-link <?php echo $item5ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item5 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-truck mr-1"></i>Fornecedores</a>

					<a class="nav-link <?php echo $item6ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item6 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-file-prescription mr-1"></i>Prescrições</a>

					<a class="nav-link <?php echo $item8ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item8 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-chart-line-down mr-1"></i>Stock Baixo</a>

					<a class="nav-link <?php echo $item9ativo ?>" id="v-pills-messages-tab" href="rel/rel_remedios_class.php?acao=<?php echo $item9?>" target="_blank" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-notes-medical mr-1"></i>Relatório de Remédios</a>

					<a class="nav-link <?php echo $item10ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item10 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-comments mr-1"></i>Chat</a>
