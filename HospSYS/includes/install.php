<?php
        ...
        CREATE TABLE `consultas` (
                ...
                FOREIGN KEY (`paciente`) REFERENCES `utilizadores` (`id`) ON DELETE CASCADE,
        ...
        CREATE TABLE `messages` (
                ...
                FOREIGN KEY (`incoming_msg_id`) REFERENCES `utilizadores` (`id`) ON DELETE CASCADE,
                FOREIGN KEY (`outgoing_msg_id`) REFERENCES `utilizadores` (`id`) ON DELETE CASCADE
        );
