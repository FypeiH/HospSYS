...
if(!isset($_SESSION['nome_utilizador']) || $_SESSION['nivel_utilizador'] == 'Farmacêutico' || $_SESSION['nivel_utilizador'] == 'Recepcionista' || $_SESSION['nivel_utilizador'] == 'Médico' || $_SESSION['nivel_utilizador'] == 'Tela')
{
		...
		<div class="row">
			<div class="col-md-3 col-sm-12 mb-4">
				<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					...
					<a class="nav-link <?php echo $item7ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item7 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-comments mr-1"></i>Chat</a>
