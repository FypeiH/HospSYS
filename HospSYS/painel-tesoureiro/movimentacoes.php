...
<div class="row mt-4">
  <div class="col-md-3 col-sm-12">
    ...
    <input class="form-control form-control-sm ml-4 mr-sm-2 " type="hidden" name="dataInicialPost" id="dataInicialPost">
    <input class="form-control form-control-sm ml-4 mr-sm-2 " type="hidden" name="dataFinalPost" id="dataFinalPost">
    <input class="form-control form-control-sm ml-4 mr-sm-2 " type="hidden" name="tipo" id="tipo">
      <button class="btn btn-light"><i class="fas fa-book mr-2"></i>Relatório</button>
    </form>
...
<div id="listar">
    ...
    <script type="text/javascript">
      $('#txtpesquisar').change(function(){
        ...
        $('#btn-pesquisar').click();
        document.getElementById('tipo').value = document.getElementById('txtpesquisar').value;
      })
    ...
    <!-- AJAX para pesquisar os dados pela data final-->
