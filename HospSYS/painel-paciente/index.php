...
$id_utilizador = $_SESSION['id_utilizador'];
 ...
 //Buscar o nif do paciente
 $resultado_nif = $pdo->query("SELECT * from utilizadores where id = '$id_utilizador'");
 $dados_nif = $resultado_nif->fetchAll(PDO::FETCH_ASSOC);
 @$nif_paciente = $dados_nif[0]['nif'];
		...
		<div class="col-md-12">
			...
			<li class="float-right nav-item dropdown">		
				...
				<a class="float-right nav-link dropdown-toggle mt-1" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					Paciente - <?php echo $nome_utilizador; ?>
				</a>
				...
				<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
					...
					<?php
						...
						{
							echo '<li><a class="dropdown-item" href="../painel-escolha/tesoureiro.php">Mudar Painel</a></li>';
						}
						else
						{
							echo '';
		...
		<div class="row">
			<div class="col-md-3 col-sm-12 mb-4">
				<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					...
					<a class="nav-link <?php echo $item2ativo ?>" id="link-medicos" href="index.php?acao=<?php echo $item2 ?>" role="tab" aria-controls="v-pills-profile" aria-selected="false"><i class="fas fa-calendar-check mr-1"></i>As suas Consultas</a>

					<a class="nav-link <?php echo $item3ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item3 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-history mr-1"></i>Histórico de Consultas</a>

					<a class="nav-link <?php echo $item4ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item4 ?>&funcao=marcacoes&id=<?php echo $id_utilizador ?>&nif=<?php echo $nif_paciente ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-calendar mr-1"></i>Marcações</a>
					
					<a class="nav-link <?php echo $item6ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item6 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-money-bill mr-1"></i>As suas Contas</a>
				</div>
			</div>
