...
<div class="row mt-4 mb-3">
  <div class="col-md-6 col-sm-12">
    <form id="frm" class="form-inline my-2 my-lg-0" method=POST>
      <input class="form-control form-control-sm mr-sm-2 " type="hidden" placeholder="NIF do Paciente" aria-label="Search" name="txtpesquisar-paciente" id="txtpesquisar-paciente" value="<?php echo @$nif_paciente ?>">
    </form>
  </div>
