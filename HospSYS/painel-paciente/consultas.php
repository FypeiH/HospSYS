...
<div class="row botao-novo">
  <div class="col-md-12">
      <a href="index.php?acao=marcacoes&funcao=pacientes&id=<?php echo $id_utilizador ?>&nif=<?php echo $nif_paciente ?>" type="button" class="btn btn-light">Marcar Consultas</a>
  </div>
</div>
